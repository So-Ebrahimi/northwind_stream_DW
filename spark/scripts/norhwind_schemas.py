...
table_mapping = {
    "categories": ["northwind_categories", "northwind.public.categories", categories_schema],
    "customer_customer_demo": ["northwind_customer_customer_demo", "northwind.public.customer_customer_demo", customer_customer_demo_schema],
    "customer_demographics": ["northwind_customer_demographics", "northwind.public.customer_demographics", customer_demographics_schema],
    "customers": ["northwind_customers", "northwind.public.customers", customers_schema],
    "employee_territories": ["northwind_employee_territories", "northwind.public.employee_territories", employee_territories_schema],
    "employees": ["northwind_employees", "northwind.public.employees", employees_schema],
    "order_details": ["northwind_order_details", "northwind.public.order_details", order_details_schema],
    "orders": ["northwind_orders", "northwind.public.orders", orders_schema],
    "products": ["northwind_products", "northwind.public.products", products_schema],
    "region": ["northwind_region", "northwind.public.region", region_schema],
    "shippers": ["northwind_shippers", "northwind.public.shippers", shippers_schema],
    "suppliers": ["northwind_suppliers", "northwind.public.suppliers", suppliers_schema],
    "territories": ["northwind_territories", "northwind.public.territories", territories_schema],
    "us_states": ["northwind_us_states", "northwind.public.us_states", us_states_schema]
}
